...
public class Pizza extends Story {
	...
	public String getStory(String[]userInput) {
		return String.format("Pizza was invented by %s %s chef named %s. \nTo make "
				...
				+ "\nIf I could, I would eat pizza %s times a day!", testForVowel(userInput[0]), userInput[1], userInput[2], userInput[3],
